...
{
    // Load base and mod as uint256 from big-endian bytes (right-aligned).
    ...
    // Store result as big-endian bytes (right-aligned to mod_bytes.size()).
    uint8_t tmp[32];
