...
if(MSVC)
    ...
    if(SP1 AND EXISTS "${BLST_PATCH_SCRIPT}")
        ...
        set(BLST_BUILD_SCRIPT ./build.sh CC='${BLST_CC}' AR='${CMAKE_AR}' RANLIB='${CMAKE_RANLIB}')
    # Airbender BigInt CSR patching: replace 384-bit Montgomery ops with CSR-accelerated versions.
    elseif(AIRBENDER)
        set(BLST_AIRBENDER_PATCH "${CMAKE_CURRENT_LIST_DIR}/patch_blst_airbender.sh")
        if(EXISTS "${BLST_AIRBENDER_PATCH}")
...
ExternalProject_Add(
    ...
    URL https://github.com/supranational/blst/archive/refs/tags/v0.3.16.tar.gz
    URL_HASH SHA256=e04805b7d6ef9e1d89b7f511a5b86136c57b455d97924d7324da2305a864673f
